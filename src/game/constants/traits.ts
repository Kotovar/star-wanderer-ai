...
> = {
    positive: [
        ...
        },
        {
            id: "veteran",
            name: "Ветеран",
            desc: "+10% точности (стрелок в орудийном отсеке), -40% урона по экипажу (не складывается с другими снижениями урона — берётся лучшее)",
    ...
    mutation: [
        ...
        },
        {
            id: "chitin",
            name: "Мутация: Хитин",
            desc: "-25% урона по экипажу в бою (не складывается с другими снижениями урона — берётся лучшее), -20% эффективность, -5 морали экипажу в модуле",
            effect: {
        ...
        },
        {
            ...
            desc: "-15 морали себе каждый ход, +10% уклонение (пилот в кабине), -10% урона по себе в бою (не складывается с другими снижениями урона — берётся лучшее), -5 морали экипажу в модуле",
            effect: {
                moralePenalty: 15,
