    ...
    ? (() => {
        const devArsenalFixture: ShipTemplate = {
          ...
          modules: [
            ...
            { id: 704, type: "quarters", name: "Жилой модуль", x: 6, y: 0, width: 1, height: 1, consumption: 1, capacity: 6, health: 250, maxHealth: 250, level: 4, defense: 5 },
            { id: 723, type: "point_defense", name: "Модуль ПРО", x: 6, y: 1, width: 1, height: 1, consumption: 7, health: 250, maxHealth: 250, level: 4, defense: 5 },
