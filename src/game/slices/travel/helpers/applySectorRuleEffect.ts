        ...
        return {
            ...
            ship: {
                ...
                bonusEvasion:
                    ...
                    nextBonuses.evasion,
                // maxShields не трогаем: он производный от модулей, и его
                // пересчитает updateShipStats — иначе щит, установленный уже
                // внутри сектора, разошёлся бы со штрафом правила.
                bonusShields:
