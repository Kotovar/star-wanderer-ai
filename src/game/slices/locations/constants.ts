...
/**
 * Сопротивление урону от штормов в зависимости от тира жизнеобеспечения.
 * Снижает урон по экипажу и модулям.
 */
export const LIFESUPPORT_HAZARD_RESISTANCE: Record<number, number> = {
    1: 0.05,
    2: 0.1,
    3: 0.15,
    4: 0.25,
