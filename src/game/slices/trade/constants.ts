...
// ============================================================================
// Константы репутации за торговлю
// ============================================================================

/** Количество товара для получения +1 репутации (за покупку) */
export const REPUTATION_BUY_THRESHOLD = 20;
