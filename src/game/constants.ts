...
export const RACES: Record<RaceId, Race> = {
    human: {
        ...
        environmentPreference: {
            ideal: ["Лесная", "Океаническая"],
            acceptable: ["Пустынная"],
            hostile: ["Вулканическая", "Ледяная", "Газовый гигант"],
        },
        crewBonuses: {
    ...
    synthetic: {
        ...
        environmentPreference: {
            ideal: ["Вулканическая"], // Don't need atmosphere
            acceptable: ["Пустынная", "Ледяная", "Газовый гигант"],
            hostile: ["Лесная", "Океаническая"],
        },
        crewBonuses: {
    ...
    xenosymbiont: {
        ...
        environmentPreference: {
            ideal: ["Океаническая"],
            acceptable: ["Лесная", "Ледяная"],
            hostile: ["Пустынная", "Вулканическая", "Газовый гигант"],
        },
        crewBonuses: {
    ...
    krylorian: {
        ...
        environmentPreference: {
            ideal: ["Пустынная"],
            acceptable: ["Вулканическая", "Лесная"],
            hostile: ["Ледяная", "Океаническая", "Газовый гигант"],
        },
        crewBonuses: {
    ...
    voidborn: {
        ...
        environmentPreference: {
            ideal: ["Газовый гигант"], // Born in gas/space
            acceptable: ["Пустынная", "Ледяная", "Вулканическая"],
            hostile: ["Лесная", "Океаническая"],
        },
        crewBonuses: {
    ...
    crystalline: {
        ...
        environmentPreference: {
            ideal: ["Ледяная"],
            acceptable: ["Пустынная", "Газовый гигант"],
            hostile: ["Лесная", "Океаническая", "Вулканическая"],
        },
        crewBonuses: {
...
export const WEAPON_TYPES = {
    kinetic: { name: "Кинетическое", damage: 15, color: "#888888", icon: "●" },
    laser: { name: "Лазерное", damage: 20, color: "#ff0000", icon: "◆" },
    missile: { name: "Ракетное", damage: 25, color: "#ffaa00", icon: "▲" },
};
