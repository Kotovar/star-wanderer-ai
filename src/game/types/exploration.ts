...
/**
 * Клетки экспедиции. Рынок, лаборатория и инцидент присущи населённым
 * планетам; руины и артефакт — общие. Только на необитаемых добавляются
 * cache, core_sample, hazard и signal; settlement внедряется отдельно.
 */
