 ...
 * торговать и чьи лаборатории обыскивать. Четыре взвешенных типа
 * необитаемых планет — cache, core_sample, hazard и signal; settlement
 * добавляется отдельно для детерминированного кандидата.
 */
