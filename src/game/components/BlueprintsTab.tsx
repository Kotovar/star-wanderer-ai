                ...
                <div className="flex flex-col gap-2">
                    ...
                    {moduleRecipes.map((recipeId) => {
                        ...
                        return (
                            <div key={recipeId}>
                                <div
                                    className="flex items-center gap-2 p-2 border border-[#00d4ff33] bg-[rgba(0,212,255,0.03)] text-xs cursor-pointer hover:border-[#00d4ff55] hover:bg-[rgba(0,212,255,0.06)] transition-colors"
                                    onClick={() => toggle(recipeId)}
                                >
