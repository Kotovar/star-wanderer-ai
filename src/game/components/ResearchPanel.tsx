    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="shrink-0 p-2 border-b border-[#1a1a1a] space-y-2">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {researchBoostEffect && (
            <div className="text-xs font-bold px-2 py-1 border border-[#00d4ff] text-[#00d4ff] bg-[rgba(0,212,255,0.06)]">
              🔬 {t("research.boost_active", {
                turnsRemaining: researchBoostEffect.turnsRemaining,
              })}
            </div>
          )}
          {activeResearch && (
