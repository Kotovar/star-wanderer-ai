                ...
                {knownRaces.map((raceId) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Bonuses */}
                            <div className="mb-2">
                                <div className="text-xs text-[#00ff41] font-bold mb-1">
                                    БОНУСЫ:
                                </div>
                            ...
                            {/* Special traits */}
                            <div className="mb-2">
                                <div className="text-xs text-[#ffaa00] font-bold mb-1">
                                    ОСОБЕННОСТИ:
                                </div>
