...
function drawTileSprite(
  ...
  ctx.drawImage(
    ...
    spriteWidth,
    spriteHeight,
    drawCenterX - drawSize / 2,
    drawCenterY - drawSize / 2,
    drawSize,
    drawSize,
  );
}
...
export function ExpeditionMapCanvas({
  ...
  useEffect(() => {
    ...
    image.src = EXPEDITION_LOCATION_SPRITE;
    image.onload = () => setLocationSprite(image);
    image.onerror = () => setLocationSprite(null);
  }, []);
