...
export const MODULES_BY_LEVEL: Record<number, ShopItem[]> = {
  1: [
    ...
    },
    {
      ...
      price: 700,
      stock: 1,
      description: "Перехватывает ракеты и торпеды",
    },
    {
      id: "weaponbay-1",
  ...
  2: [
    ...
    },
    {
      ...
      price: 1400,
      stock: 1,
      description: "Улучшенная система перехвата ракет и торпед",
    },
    {
      id: "weaponbay-2",
      name: "Оружейная палуба",
  ...
  3: [
    ...
    },
    {
      ...
      price: 2400,
      stock: 1,
      description: "Продвинутая ПРО с усиленными системами наведения",
    },
    {
      id: "scanner-3",
      name: "Сканер",
...
const UPGRADES_BY_TIER: Record<number, ShopItem[]> = {
  1: [
    ...
    {
      id: "point-defense-upgrade-1",
      name: "Улучшение ПРО",
      type: "upgrade",
      targetType: "point_defense",
      price: 1500,
      effect: { level: 1 },
      stock: 1,
      moduleType: "point_defense",
      description: "Повышает уровень модуля ПРО и шанс перехвата",
    },
    {
...
const WEAPONS: ShopItem[] = [
  ...
  },
  {
    ...
    type: "weapon",
    weaponType: "siege_torpedo",
    price: 1600,
    stock: 1,
    requiresWeaponBay: true,
    moduleType: "weaponShed",
    description: "Медленная тяжёлая торпеда с огромным уроном",
  },
];
