              ...
              <div className="grid grid-cols-2 gap-1.5 text-sm">
                <div className="flex items-center gap-1.5 text-[#00ff41]">
                  ...
                  <span>
                    ...
                    <strong>+{miningResult.minerals}</strong>
                  </span>
                </div>
                {miningResult.rare > 0 && (
                  <div className="flex items-center gap-1.5 text-[#00ff41]">
                    ...
                    <span>
                      ...
                      <strong>+{miningResult.rare}</strong>
                    </span>
                  </div>
                )}
                <div className="flex items-center gap-1.5 text-accent">
                  ...
                  <span>
                    ...
                    <strong>+{miningResult.credits}₢</strong>
                  </span>
                </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            {[
              {
                icon: "📦",
                label: t("asteroid_belt.minerals"),
                val: resources.minerals,
                color: "#00ff41",
              },
              {
                icon: "💎",
                label: t("asteroid_belt.rare_minerals"),
                val: resources.rare,
                color: "#00d4ff",
              },
              {
                icon: "₢",
                label: t("asteroid_belt.valuable_samples"),
                val: resources.credits,
                color: "#ffb000",
              },
              ...
              >
                ...
                <span
                  ...
                  style={{ color: scanRange >= 5 ? color : "#444" }}
                >
                  {scanRange >= 5 ? `~${val}` : "???"}
                </span>
              </div>
        ...
        <div
          className="rounded p-3"
          style={{ background: "rgba(0,0,0,0.3)", border: "1px solid #1a2a1a" }}
        >
